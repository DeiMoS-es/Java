...
import com.apiRest.pedido.exception.PedidoException;
...
public class PedidoServiceImpl implements PedidoService {
    ...
    public void guardarPedido(List<ProductoDTO> listaProductos) {
        if(!listaProductos.isEmpty()){
            ...
            MensajeUtil.mensajeConfirmacion("El pedido se ha guardado");
        } else {
            throw new PedidoException("El pedido no se ha podido crear");
        }
    }
}
